...
class WebFluxObservationAutoConfigurationTests {
	...
	/**
	 * Verifies that the WebFluxObservationFilter is provided and ordered correctly.
	 */
	...
	/**
	 * Verifies that a custom convention is used when available.
	 */
	...
	/**
	 * Verifies the behavior when the maximum number of URI tags is reached.
	...
	/**
	 * Verifies the behavior when the maximum number of URI tags is reached with a custom observation name.
	 * @param output The captured output.
	 */
	...
	/**
	 * Verifies the behavior when the maximum number of URI tags is not reached.
	 * @param output The captured output.
	 */
