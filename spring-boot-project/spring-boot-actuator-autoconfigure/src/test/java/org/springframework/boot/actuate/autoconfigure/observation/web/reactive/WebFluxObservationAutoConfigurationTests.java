...
class WebFluxObservationAutoConfigurationTests {
	...
	/**
	 * Verifies that the application context provides the WebFlux observation filter.
	 */
	...
	/**
	 * Verifies that the WebFlux observation filter is provided in the correct order when custom web filters are present.
	 */
	...
	/**
	 * Verifies that a custom observation convention is used when available in the application context.
	 */
	...
	/**
	 * Verifies the behavior when the maximum number of URI tags is reached, and further URIs are denied.
	...
	/**
	 * Verifies the behavior when the maximum number of URI tags is reached, and further URIs are denied when using a custom observation name.
	 * @param output The captured output
	 */
	...
	/**
	 * Verifies that observations are not recorded when actuator observations are disabled using a custom Webflux base path.
	 */
	 ...
	 */
	/**
	 * Verifies that observations are not recorded when actuator observations are disabled using a custom Webflux base path and custom endpoint base path.
	 */
	...
	/**
	 * Verifies that there is no denial or logging when the maximum number of URI tags is not reached.
	 * @param output The captured output
	 */
