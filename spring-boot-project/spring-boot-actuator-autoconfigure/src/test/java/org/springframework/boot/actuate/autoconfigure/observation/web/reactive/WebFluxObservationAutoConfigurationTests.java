...
class WebFluxObservationAutoConfigurationTests {
	...
	/**
	 * Verifies that the WebFluxObservationFilter is provided.
	 */
	...
	/**
	 * Verifies that the WebFluxObservationFilter is provided in a specific order.
	 */
	...
	/**
	 * Verifies the usage of a custom convention when available.
	 */
	...
	/**
	 * Verifies the behavior when the maximum number of URIs is reached, further URIs are denied.
	 * @param output The CapturedOutput for logging.
	 */
	...
	/**
	 * Verifies the behavior when the maximum number of URIs is reached with a custom observation name, further URIs are denied.
	 * @param output The CapturedOutput for logging.
	 */
	...
	/**
	 * Verifies that observations are not recorded when Actuator observations are disabled with a custom endpoint base path.
	 */
	...
	/**
	 * Verifies that observations are not recorded when Actuator observations are disabled with a custom Webflux base path.
	 */
	 ...
	 */
	/**
	 * Verifies that observations are not recorded when Actuator observations are disabled with a custom Webflux base path and custom endpoint base path.
	 */
	...
	/**
	 * Verifies that no denial or log occurs when the maximum number of URIs is not reached.
	 * @param output The CapturedOutput for logging.
	 */
