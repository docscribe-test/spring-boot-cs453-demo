...
class WebFluxObservationAutoConfigurationTests {
	...
	/**
	 * Verifies the behavior when the maximum number of URIs is reached.
	...
	/**
	 * Verifies the behavior when the maximum number of URIs is reached with a custom observation name.
	 * @param output The captured output.
	 */
	...
	/**
	 * Verifies the behavior when the maximum number of URIs is not reached.
	 * @param output The captured output.
	 */
