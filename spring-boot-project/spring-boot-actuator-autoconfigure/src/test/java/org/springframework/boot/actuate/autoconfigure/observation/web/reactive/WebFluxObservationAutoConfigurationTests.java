...
class WebFluxObservationAutoConfigurationTests {
	...
	/**
	 * Verifies that the application provides the WebFluxObservationFilter.
	 */
	...
	/**
	 * Verifies that the application provides the WebFluxObservationFilter in a specific order.
	 */
	...
	/**
	 * Verifies that the application uses a custom convention when available for observations.
	 */
	...
	/**
	 * Verifies that after reaching the maximum number of URIs, further URIs are denied.
	...
	/**
	 * Verifies that after reaching the maximum number of URIs with a custom observation name, further URIs are denied.
	 * @param output The captured output
	 */
	 ...
	 */
	/**
	 * Verifies that observations are not recorded when Actuator observations are disabled using a custom Webflux base path and a custom endpoint base path.
	 */
	...
	/**
	 * Verifies that if the maximum number of URIs is not reached, there should be no denial or logging.
	 * @param output The captured output
	 */
